...
filepath_linux = ('C:/Users/Admin/OneDrive/Coding/Predictions/ETS/')
filepath_windows = ('C:/Users/Will/OneDrive/Coding/Predictions/ETS/')
...
def model_creator(data_full, ticker, model_creator_starttime, cnt):
   ...
   #parameters to be tuned
    ...
    randm_src_extra_trees = RandomizedSearchCV(estimator=extra_tree, param_distributions = parameters_extra_trees,
                                   cv = 5, n_iter = 10, verbose = 1, n_jobs=-1, random_state=23)
                                       #parameters to be tuned
