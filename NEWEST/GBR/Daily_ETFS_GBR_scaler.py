...
def optimizer():
    ...
    for i in tickerlist:
        ...
        scaler_used = scaler.fit(X_train)
        X_train_scaled = scaler_used.transform(X_train)
        scalerrr = scaler.fit(X_test)
        X_test_scaled = scalerrr.transform(X_test)
        ...
        randm_src.fit(X_train_scaled, y_train)
        print("Optimization complete for:", ticker)
        print("Model fit for:", ticker + "\n----------------")
        
        
        y_pred = randm_src.predict(X_test_scaled)
